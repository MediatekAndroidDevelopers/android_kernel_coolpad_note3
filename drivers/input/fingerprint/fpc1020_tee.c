...
#define GPIO_FPC_SPI_CS             (65 | 0x80000000)
#define GPIO_FPC_SPI_CLK            (66 | 0x80000000)
#define GPIO_FPC_SPI_MISO           (67 | 0x80000000)
#define GPIO_FPC_SPI_MOSI           (68 | 0x80000000)
#define GPIO_PIN_IRQ                (11 | 0x80000000)
#define GPIO_PIN_RESET              (59 | 0x80000000)
