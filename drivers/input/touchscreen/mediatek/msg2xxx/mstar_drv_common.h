 ...
 */
#define CONFIG_PLATFORM_USE_ANDROID_SDK_6_UPWARD  //wangsl
 ...
 * By default, this compile option is disabled.
 */
#if defined(CONFIG_TOUCH_MSTAR_GESTURE_WAKEUP) //wangsl
#define CONFIG_ENABLE_GESTURE_WAKEUP   //luojy 20150915 for TP Gesture wakeup
#endif
 ...
 * By default, this compile option is disabled.
 */
#if defined(CONFIG_TOUCH_MSTAR_PROXIMITY) //wangsl
 ...
 * By default, this compile option is enabled.
 */
//#define CONFIG_ENABLE_JNI_INTERFACE   //wangsl
 ...
 * By default, this compile option is disabled.
 */
//#define CONFIG_ENABLE_CODE_FOR_DEBUG  //wangsl
