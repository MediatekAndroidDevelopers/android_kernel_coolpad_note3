...
//add by wangyufei begin  20160630
struct acc_offset{
...
#define ACCELER_BOTTOM_CALIBRATE
#define CAL_MODE 1

/*#ifdef ACCELER_BOTTOM_CALIBRATE
#define CAL_FUZZ	550
#else
#define CAL_FUZZ	157
#endif*/

#define CAL_CONVERT 0

#define MPU60X0_IOCTL_MAGIC      'd'
#define ACC_CALIBRATE	_IOR(MPU60X0_IOCTL_MAGIC, 6, short)

//add by wangyufei end  20160630
