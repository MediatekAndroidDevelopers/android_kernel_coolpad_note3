...
#if 1 //wangsl
{
	gpio_request(GPIO_LED_G_MODE_PIN, "gpio_for_g_led");
	gpio_request(GPIO_LED_B_MODE_PIN, "gpio_for_b_led");
	gpio_direction_output(GPIO_LED_G_MODE_PIN, 0);
	gpio_direction_output(GPIO_LED_B_MODE_PIN, 0);
}
#endif
#ifdef CONFIG_OF
...
{
#if 1 //wangsl
	gpio_free(GPIO_LED_G_MODE_PIN);
	gpio_free(GPIO_LED_B_MODE_PIN);
#endif
