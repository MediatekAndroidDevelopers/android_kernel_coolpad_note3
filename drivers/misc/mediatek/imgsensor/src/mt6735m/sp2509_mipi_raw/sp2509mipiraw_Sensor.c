...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SP2509_SENSOR_ID,//SP2509MIPI_SENSOR_ID,
	...
	#if defined(SP2509_CHENGXIANGTONG) || defined(SP2509_BAIKANG) || defined(SP2509_WEIXUN)|| defined(SP2509_SHENGTAI) //wangsl
...
static kal_uint32 read_cmos_sensor0(kal_uint32 addr)
{
	return 0;
}

static kal_uint32 write_cmos_sensor0(kal_uint32 addr, kal_uint32 para)
{
	return 0;
}
