...
#define VOL_1000 1000000
	...
	if (DUAL_CAMERA_MAIN_SENSOR == SensorIdx)
		...
		pinSetIdx = 2;
	printk("[wsl]enter camera_hw Power on ************************************************************\n");
	if (On) {
		...
		//wangsl
			   ...
			   && (0 == strcmp(SENSOR_DRVNAME_OV9762_MIPI_RAW, currSensorName))) {
			
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx_2][IDX_PS_CMPDN]) {
				mtkcam_gpio_set(pinSetIdx_2, CAMPDN,
						pinSet[pinSetIdx_2][IDX_PS_CMPDN + IDX_PS_OFF]);
			}
			/* Set Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx_2][IDX_PS_CMRST]) {
				mtkcam_gpio_set(pinSetIdx_2, CAMRST,
						pinSet[pinSetIdx_2][IDX_PS_CMRST + IDX_PS_OFF]);
			}
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
						pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
		...
		//wangsl
			   ...
			   && (0 == strcmp(SENSOR_DRVNAME_GC5005_MIPI_RAW_KANGLONG, currSensorName))) {
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
						pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
		...
		//wangsl
			...
			mdelay(20);
				   ...
				   && (0 ==
				       strcmp(SENSOR_DRVNAME_HI843B_MIPI_RAW, currSensorName))){
		...
		//wangsl
			   ...
			   && (0 == strcmp(SENSOR_DRVNAME_SP8408_MIPI_RAW, currSensorName))) {
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(pinSetIdx, CAMPDN,
						pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON]);
