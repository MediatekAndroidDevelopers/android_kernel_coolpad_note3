...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        .pclk = 104000000,            //record different mode's pclk
        .linelength = 3151, //3694,            //record different mode's linelength, nick-diff
        .framelength = 1100, //2021,            //record different mode's framelength
    ...
    .cap = {
        .pclk = 111800000,
        .linelength = 3696, //3151, nick-diff
    ...
    .normal_video = {
        .pclk = 104000000,
        .linelength = 3151, //3694, nick-diff
        .framelength = 1100, //2021,
        .startx = 2,
        .starty = 3,
...
{{ 2608, 1960,      8,    8, 2592, 1944, 1296,  972,      0,   0, 1296,  972,  0,    1, 1280,  960},  // Preview
 ...
 { 2608, 1960,      8,    8, 2592, 1944, 1296,  972,      0,   0, 1296,  972,  0,    1, 1280,  960}}; // slim video
...
static void preview_setting(void)
{
    ...
    write_cmos_sensor(0x3002, 0x0008);    // X_ADDR_START   =  8 
    write_cmos_sensor(0x3004, 0x0008);    // Y_ADDR_START   =  8
    write_cmos_sensor(0x3008, 0x0A27);    // X_ADDR_END      = 2599
    write_cmos_sensor(0x3006, 0x079F);    // Y_ADDR_END       =  1951
...
static void capture_setting(kal_uint16 currefps)
{
  //  LOG_INF("E! currefps:%d\n", currefps);
    ...
    write_cmos_sensor(0x300C, 0x0E70);    //Line Length = 0xE6E  3694  0xE70 3696
...
static void normal_video_setting(kal_uint16 currefps)
{
  //  LOG_INF("E! currefps:%d\n", currefps);
    ...
    write_cmos_sensor(0x3002, 0x0008);    // Y_ADDR_START   =  8 
    write_cmos_sensor(0x3004, 0x0008);    // X_ADDR_START   =  8
    write_cmos_sensor(0x3008, 0x0A27);    // X_ADDR_END      = 2599
    write_cmos_sensor(0x3006, 0x079F);    // Y_ADDR_END       =  1951
    temp = read_cmos_sensor(0x3040);
    temp = temp & 0xF000;
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            printk("A5142 Read sensor id fail, id: 0x%x\n", *sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
