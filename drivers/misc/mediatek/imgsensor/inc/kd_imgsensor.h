...
//zhuyifeng
#define KDIMGSENSORIOC_X_SEARCH_SENSOR             _IOWR(IMGSENSORMAGIC,85,u32)
#define KDIMGSENSORIOC_X_CUST_CLOSE_SENSOR         _IOWR(IMGSENSORMAGIC,90,u32)
...
#define SP8408_SENSOR_ID					0x1490
...
#define SENSOR_DRVNAME_GC5005_MIPI_RAW_KANGLONG          "gc5005mipirawkanglong"
