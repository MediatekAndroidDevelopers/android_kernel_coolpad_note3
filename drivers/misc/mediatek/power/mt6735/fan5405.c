...
void fan5405_hw_component_detect(void)
{
	...
	printk("[ws] enter fan5405_hw_component_detect \n");
...
void fan5405_hw_init(void)
{
	...
	fan5405_reg_config_interface(0x06,0x77); // set ISAFE & VSAFE 4.34V
#else
	fan5405_reg_config_interface(0x06,0x70); // set ISAFE & VSAFE 4.2V
#endif
}
#endif
...
static int fan5405_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	printk("[ws] enter fan5405 i2c probe");
