...
//extern struct gyro_hw* lsm6ds3_get_cust_gyro_hw(void) ;  //shihaobin@yulong.com add for compatible 20150410
...
//static struct i2c_board_info __initdata i2c_lsm6ds3_gyro={ I2C_BOARD_INFO(LSM6DS3_GYRO_DEV_NAME, (0xD2>>1))}; //0xD4>>1 is right address
...
static int LSM6DS3_ReadGyroData(struct i2c_client *client, char *buf, int bufsize)
{
...
#endif
#if 1
        obj->data[LSM6DS3_AXIS_X] = (s64)(obj->data[LSM6DS3_AXIS_X]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
        obj->data[LSM6DS3_AXIS_Y] = (s64)(obj->data[LSM6DS3_AXIS_Y]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
        obj->data[LSM6DS3_AXIS_Z] = (s64)(obj->data[LSM6DS3_AXIS_Z]) * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
    ...
    //shihaobin add for gyro-sensor calibrate begin 20150330
    read_gyro_data[LSM6DS3_AXIS_X] = data[LSM6DS3_AXIS_X];
    read_gyro_data[LSM6DS3_AXIS_Y] = data[LSM6DS3_AXIS_Y];
    read_gyro_data[LSM6DS3_AXIS_Z] = data[LSM6DS3_AXIS_Z];
    //shihaobin add for gyro-sensor calibrate end 20150330
...
static int lsm6ds3_gyro_enable_nodata(int en)
{
    ...
    {
        enable_flag = 1;
        yulong_gyro_ReadCalibration(lsm6ds3_i2c_client);
    }
       ...
       unsigned long arg)
{
    ...
    switch(cmd)
    {
        ...
        case GYRO_CALIBRATE:
            ...
            yulong_gyro_Calibration(client, strbuf, LSM6DS3_BUFSIZE , 20, arg);
        ...
        case GYROSCOPE_IOCTL_SET_CALI:
            ...
            {
                cali[LSM6DS3_AXIS_X] = (s64)(sensor_data.x);// * 180*1000/(LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142);
                cali[LSM6DS3_AXIS_Y] = (s64)(sensor_data.y);// * 180*1000/(LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142);
                cali[LSM6DS3_AXIS_Z] = (s64)(sensor_data.z);// * 180*1000/(LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142);
        ...
        case GYROSCOPE_IOCTL_GET_CALI:
            ...
            sensor_data.x = (s64)(cali[LSM6DS3_AXIS_X]);// * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
            sensor_data.y = (s64)(cali[LSM6DS3_AXIS_Y]);// * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
            sensor_data.z = (s64)(cali[LSM6DS3_AXIS_Z]);// * LSM6DS3_GYRO_SENSITIVITY_2000DPS*3142/(180*1000);
...
static int yulong_gyro_Calibration(struct i2c_client *client, char *buf, int bufsize,int count,unsigned long cal_arg)
{
    ...
    for (i = 0; i < count; i++)
    {
        ...
        xavg += read_gyro_data[LSM6DS3_AXIS_X];
        yavg += read_gyro_data[LSM6DS3_AXIS_Y];
        zavg += read_gyro_data[LSM6DS3_AXIS_Z];
    }
    ...
    cali[LSM6DS3_AXIS_X] = -cali[LSM6DS3_AXIS_X];
    cali[LSM6DS3_AXIS_Y] = -cali[LSM6DS3_AXIS_Y];
    cali[LSM6DS3_AXIS_Z] = -cali[LSM6DS3_AXIS_Z];

    ret = LSM6DS3_gyro_WriteCalibration(client, cali);

    printk("GYRO fwq GSENSOR_IOCTL_SET_CALI!!obj->sensitivity = %d,cali[LSM6DS3_AXIS_X] =%d,scali[LSM6DS3_AXIS_X] =%d,cali[LSM6DS3_AXIS_X] =%d \n",obj->sensitivity,cali[LSM6DS3_AXIS_X],cali[LSM6DS3_AXIS_Y],cali[LSM6DS3_AXIS_Z]);

    ((struct gyro_offset *)gyro_cal_ptr)->x = obj->cali_sw[LSM6DS3_AXIS_X];
    ((struct gyro_offset *)gyro_cal_ptr)->y = obj->cali_sw[LSM6DS3_AXIS_Y];
    ((struct gyro_offset *)gyro_cal_ptr)->z = obj->cali_sw[LSM6DS3_AXIS_Z];
    ((struct gyro_offset *)gyro_cal_ptr)->key = ret ? 2 : 1;

    printk("GYRO(%d),obj->cali_sw[LSM6DS3_AXIS_X] is %d,obj->cali_sw[LSM6DS3_AXIS_Y] is %d,obj->cali_sw[LSM6DS3_AXIS_Z] is %d\n",
...
static int yulong_gyro_ReadCalibration(struct i2c_client *client)
{
    ...
    if(read_acc_ps_cal_data_from_flash(32, tempbuf, NAND_FLASH_WR_RD_SIZE)<0){
        printk("GYRO use Default CALI , cali_sw[LSM6DS3_AXIS_X] = %d , cali_sw[LSM6DS3_AXIS_Y] = %d, cali_sw[LSM6DS3_AXIS_Z] = %d\n",
        obj->cali_sw[LSM6DS3_AXIS_X],obj->cali_sw[LSM6DS3_AXIS_Y],obj->cali_sw[LSM6DS3_AXIS_Z]);
    }
    else{
        ...
        printk("GYRO use yulong CALI , cali_sw[LSM6DS3_AXIS_X] = %d , cali_sw[LSM6DS3_AXIS_Y] = %d, cali_sw[LSM6DS3_AXIS_Z] = %d\n",
            obj->cali_sw[LSM6DS3_AXIS_X],obj->cali_sw[LSM6DS3_AXIS_Y],obj->cali_sw[LSM6DS3_AXIS_Z]);
...
static int lsm6ds3_gyro_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    obj->hw = hw; //lsm6ds3_get_cust_gyro_hw();
    ...
    client->addr = LSM6DS3_I2C_SLAVE_ADDR>>1;
    obj_i2c_data = obj;
    obj->client = client;
...
{
    struct gyro_hw *gy_hw = hw; //lsm6ds3_get_cust_gyro_hw();
    GYRO_FUN();
...
static int __init lsm6ds3_gyro_init(void)
{
    ...
    printk("yl_sensor_debug %s i2c_address = %x\n", __func__, (LSM6DS3_I2C_SLAVE_ADDR>>1));
