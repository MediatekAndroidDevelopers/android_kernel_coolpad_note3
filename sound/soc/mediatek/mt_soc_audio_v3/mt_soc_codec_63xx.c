...
//zhuyifeng
static void set_ext_aud_amp_mod(char mode)
{
	char pulse;
...
#else
	//zhuyifeng
	#if defined(EXT_AUD_AMP_MOD_4)
		set_ext_aud_amp_mod(4);
	#elif defined(EXT_AUD_AMP_MOD_3)
		set_ext_aud_amp_mod(3);
	#elif defined(EXT_AUD_AMP_MOD_2)
		set_ext_aud_amp_mod(2);
	#else/*EXT_AUD_AMP_MOD_1*/
		set_ext_aud_amp_mod(1);
	#endif/*EXT_AUD_AMP_MOD_4*/
